...
#endif
#if defined(CONFIG_NUBIA_CHARGE_DOCK_FEATURE)
	case POWER_SUPPLY_PROP_DOCK_RERUN_APSD:
		// pr_err("=========get== POWER_SUPPLY_PROP_DOCK_RERUN_APSD\n");
		break;
	case POWER_SUPPLY_PROP_DOCK_ENABLE_FLOAT:
		// pr_err("=========get== POWER_SUPPLY_PROP_DOCK_ENABLE_FLOAT\n");
		break;
#endif
	default:
...
#if defined(CONFIG_NUBIA_CHARGE_DOCK_FEATURE)
	case POWER_SUPPLY_PROP_DOCK_RERUN_APSD:
		rc = smblib_dock_apsd_rerun(chg,val);
		break;
	case POWER_SUPPLY_PROP_DOCK_ENABLE_FLOAT:
		rc = smblib_dock_chg_enable_float(chg, val);
		break;
#endif
	default:
		rc = -EINVAL;
